 ...
 * larger timeFrame. It also provides functionality to mark certain
 * timeFrames.
 */
...
qx.Class.define('timeslider.TimeSlider', {
    ...
    members: {
        ...
        _createChildControlImpl: function(id){
            ...
            switch(id){
                case 'time-selector':
                    ...
                    this._add(control, { top: 0, left: 0, bottom: 0 });
                break;
         ...
         *
         * @param timeSelection {netrp_client.data.TimeFrame} The timeFrame that
        ...
        _updateTimeSelFromPx: function(x,width){
            ...
            var ts = new netrp_client.data.TimeFrame(start,end);
        ...
        _renderBackground: function(timeFrame,width,height){
            ...
            var html = '<table border=1 rules=all width=' + width + ' height=' + height +
                ' bordercolor="' + borderCol  + '"; style="border-collapse:collapse; table-layout:fixed;">';
    ...
    properties: {
        ...
        timeFrame: {
            check: 'netrp_client.data.TimeFrame',
